...
public interface WheelRepository extends JpaRepository<Wheel, Integer> {
     ...
     * 메인페이지
     */
    @Query("SELECT w, w.serialNumber, w.oht.serialNumber, w.position, c1.diameter, c1.crack, c1.stamp, c1.abrasion FROM Wheel w " +
            ...
            "AND (c1.crack = true or c1.stamp = true or c1.abrasion = true)")
